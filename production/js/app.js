...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leftFilter = __webpack_require__(50);
	...
	var _similar = __webpack_require__(58);

	var _similar2 = _interopRequireDefault(_similar);

	var _newsOnce = __webpack_require__(59);
	...
	var _yandexMapContacts = __webpack_require__(63);

	var _yandexMapContacts2 = _interopRequireDefault(_yandexMapContacts);

	var _geographyOfSales = __webpack_require__(64);

	var _geographyOfSales2 = _interopRequireDefault(_geographyOfSales);

	var _diseaseDirectory = __webpack_require__(65);
	...
	var Header = function (_Module) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function init() {
	            ...
	            this.$two_submenu = (0, _jquery2.default)('.js-header-submenu-two', this.$root);
	...
	var Filter = function (_Module) {
	    ...
	    _createClass(Filter, [{
	        ...
	        value: function init() {
	            ...
	            this.$slider_age = (0, _jquery2.default)('.js-left-filter-age', this.$root);
	            this.$slider_price = (0, _jquery2.default)('.js-left-filter-price', this.$root);
	        ...
	        value: function initSliderAge() {
	            ...
	            (0, _jquery2.default)('.js-left-filter-from-age').val((0, _jquery2.default)(".js-left-filter-age").slider("values", 0));

	            (0, _jquery2.default)('.js-left-filter-to-age').val((0, _jquery2.default)(".js-left-filter-age").slider("values", 1));
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	( function( factory ) {
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1), __webpack_require__(52) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {
	...
	var GeographyOfSales = function (_Module) {
	    ...
	    _createClass(GeographyOfSales, [{
	        ...
	        value: function init() {
	            ...
	            _App2.default.doc.on('resize', _jquery2.default.proxy(this.getClient, this));
	            this.$geo_title.on('click', _jquery2.default.proxy(this.openList, this));
	        }
